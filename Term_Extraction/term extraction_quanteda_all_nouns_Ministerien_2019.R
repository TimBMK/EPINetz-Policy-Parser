...
folder_loc <- "/data/wolfeswenker/Projekte/Policy_Parser/nouns_Ministerien_year/2019/RDA/"
files <- paste0(folder_loc,list.files(folder_loc))[1:26]

names <- gsub('_neg.RDA', '', files)
names <- gsub('/data/wolfeswenker/Projekte/Policy_Parser/nouns_Ministerien_year/2019/RDA/', '', names)
