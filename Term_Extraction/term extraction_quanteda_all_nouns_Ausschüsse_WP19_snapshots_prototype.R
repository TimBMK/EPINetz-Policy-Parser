...
folder_loc <- "/data/wolfeswenker/Projekte/Policy_Parser/RDA_nouns_Ausschüsse_WP19_Q1-2019/"
files <- paste0(folder_loc,list.files(folder_loc))[1:44]
  
names <- gsub('_neg.RDA', '', files)
names <- gsub('/data/wolfeswenker/Projekte/Policy_Parser/RDA_nouns_Ausschüsse_WP19_Q1-2019/', '', names)

#setwd("/data/wolfeswenker/Projekte/Policy_Parser/Term_Extraction_nouns_Ausschüsse_WP19_Q1-2019_stopwords")
#setwd("/data/wolfeswenker/Projekte/Policy_Parser/Term_Extraction_nouns_Ausschüsse_WP19_Q1-2019_stopwords5")
#setwd("/data/wolfeswenker/Projekte/Policy_Parser/Term_Extraction_nouns_Ausschüsse_WP19_Q1-2019_stopwords2")
setwd("/data/wolfeswenker/Projekte/Policy_Parser/Term_Extraction_nouns_Ausschüsse_WP19_Q1-2019")
i=0
