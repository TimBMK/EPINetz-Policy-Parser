...
folder_loc <- "/data/wolfeswenker/Projekte/Policy_Parser/RDA_nouns_Ministerien/"
files <- paste0(folder_loc,list.files(folder_loc))[1:26]

names <- gsub('_neg.RDA', '', files)
names <- gsub('/data/wolfeswenker/Projekte/Policy_Parser/RDA_nouns_Ministerien/', '', names)

setwd("/data/wolfeswenker/Projekte/Policy_Parser/Term_Extraction_nouns_Ministerien_WP19_2019_prototype")
i=0
